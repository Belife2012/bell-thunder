...
class SPEAKER_THUNDER
{
public:
    /**
     * @brief: 喇叭声音，包括了音符、吉他和弦、
     * 英语、汉语、机器声、动物声和一些功能声音
     * 
     */
    typedef enum
    {
        SOUND_MUSIC_A0 = 0,         // 音符 A，音调 0 
        SOUND_MUSIC_A1,             
        SOUND_MUSIC_A2,
        SOUND_MUSIC_A3,
        SOUND_MUSIC_A4,
    ...
    SPEAKER_THUNDER(int DataPin, int BusyPin); // 配置引脚

    int WT588_Busy_Check(void); // 获取播放状态

    /*--------------Thunder IDE APIs: -------------*/
    void Set_Sound_Volume(int data); // 音量调节 范围0~100
    void Set_Sound_Level(int data); // 音量调节 范围0~15
